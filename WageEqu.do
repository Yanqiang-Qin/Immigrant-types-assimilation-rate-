...
** Augmented Mincer regression - PSM-DiD **	
	*User needs to select control immigrant group under D_F00
qui {	
...
twoway (kdensity _ps if D_F00==1 & d_y==0) (kdensity _ps if D_F00==0 & d_y==0, lpattern(dash)), legend( label( 1 "Family Immigrants") label(  2 "Refugees" ) ) xtitle("Propensity Score Comparison without Weights")
...
est store basic
*Full*
reg logwage i.D_F00##i.d_y c.age agesq agecu agefo i.white educ nchild i.marr i.female [aw=_weights], robust
est store controls
****FE****
xtset id year
*Simple FE*
...
*Full FE*
reg logwage i.D_F00##i.d_y c.age agesq agecu agefo i.white educ nchild i.marr i.female i.statefip i.yrimmig [aw=_weights], robust	
est store fe
